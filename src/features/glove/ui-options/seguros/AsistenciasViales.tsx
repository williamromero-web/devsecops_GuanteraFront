...
export function AsistenciasViales({
  plate: _plate,
}: Readonly<AsistenciasVialesProps>) {
  ...
  const img1 = new URL("../../../../assets/assistance/1.webp", import.meta.url)
    .href;
  const img2 = new URL("../../../../assets/assistance/2.webp", import.meta.url)
    .href;
  const img3 = new URL("../../../../assets/assistance/3.webp", import.meta.url)
    .href;
  const img4 = new URL("../../../../assets/assistance/4.webp", import.meta.url)
    .href;
  const img5 = new URL("../../../../assets/assistance/5.webp", import.meta.url)
    .href;
  const img6 = new URL("../../../../assets/assistance/6.webp", import.meta.url)
    .href;
