...
export function OtrosDocumentos({ plate }: Readonly<OtrosDocumentosProps>) {
  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
      ...
      >
        ...
        {documentsExpanded && (
          <DocumentUploadCard
            instruction={`Adjunte aquí otros documentos relacionados con el vehículo (Placa: ${plate}).`}
            hasFile={hasFile}
            fileName={fileName}
            fileSizeLabel={fileSizeLabel}
            onView={() =>
              setMessage(
                "Vista previa (mock): aquí se abriría el documento desde la API.",
              )
            }
